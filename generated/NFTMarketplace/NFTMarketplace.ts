...
export class CanceListingCall extends ethereum.Call {
  get inputs(): CanceListingCall__Inputs {
    return new CanceListingCall__Inputs(this);
  }

  get outputs(): CanceListingCall__Outputs {
    return new CanceListingCall__Outputs(this);
  }
}

export class CanceListingCall__Inputs {
  _call: CanceListingCall;

  constructor(call: CanceListingCall) {
    this._call = call;
  }
...
export class CanceListingCall__Outputs {
  _call: CanceListingCall;
